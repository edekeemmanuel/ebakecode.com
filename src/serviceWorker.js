...
var registerServiceWorker = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, navigator.serviceWorker.register("/serviceWorker.ts", {
                        scope: "/",
                    })];
            case 2:
            ...
            case 4:
                ...
                if ("serviceWorker" in navigator) {
                    try {
                        navigator.serviceWorker.getRegistration("/serviceWorker.ts").then(function (registration) {
                            if (registration) {
                        ...
                        console.error("Service worker not ready: ".concat(error));
                    }
                }
                else {
...
(0, exports.registerServiceWorker)();
