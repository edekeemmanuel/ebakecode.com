...
const CustomBurgerIcon = () => <FaHamburger className="hover:text-neutral-50 text-amber-500 text-3xl 2xs:text-4xl xs:text-5xl md:text-6xl lg:text-7xl border-0 outline-0 hover:border-0 hover:outline-0 " />
...
const Sidebar = () => {
  return (
    <div  className="myPhone:w-[20%] relative myPhone:pl-9 4xs:pl-6 md:pl-20 4xs:py-2 md:p-6 myPhone:p-3 3xs:pl-11 xs:pl-14 mlg:pl-32">
