...
const Greeting = () => {
  ...
  return (
  <div className="w-[100%] h-14 2xs:h-16 bg-white 4xs:text-[10px] myPhone:text-xs 2xs:text-[16px] md:text-[25px] lg:text-[30px] mlg:w-[55%] sm:w-[65%] myPhone:w-[60%] 4xs:w-[60%] text-black relative left-2.5 ">
        <Slider
      settings={{
        slidesPerView: 1,
