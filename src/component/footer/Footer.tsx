  ...
  return  (
    <footer className="bg-blue-900 ">
      <div className="flex py-2 text-amber-500 ">
        <div className="relative left-4 flex text-2xl text-neutral-50 top-3">
         <a className="">
          <span>&#128640;</span>
