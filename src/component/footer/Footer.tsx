...
const Footer = () => {
  ...
  return  (
    <footer className="bg-white text-black">
      <div className="cursor-pointer flex py-2 sm:py-5 hover:text-amber-500 ">
        <div className="relative left-4 flex text-2xl xs:text-3xl text-neutral-50 top-3 xs:top-6 sm:text-5xl mlg:left-[7%] text-black">
         <a className="">
          <span>&#128640;</span>
          <span className="text-[10px] relative top-4 sm:top-6 md:top-7 right-8 sm:right-12 md:text-[15px] text-black">project</span>
         </a>
         <a className="relative right-5">
          <span>&#128221;</span>
          <span className="text-[10px] relative top-4 sm:top-6 md:top-7 md:right-[48px] sm:right-[40px] right-[26px] md:text-[15px] text-black">blog</span>
         </a>
