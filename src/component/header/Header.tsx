...
const Header = () => {
  return  (
    ...
    <div className="">
      ...
      <span className="relative myPhone:left-2 myPhone:text-[6px] 4xs:text-[12px] 4xs:bottom-1 3xs:text-[15px] 2xs:text-[18px] xs:text-[20px] xs:right-9 3xs:right-7 sm:text-[18px] sm:right-12 md:text-[20px] md:right-16">LinkedIn</span>
      </a>
    </div>
    <div className="relative left-[25%]">
      <a className="leading-6 2xs:leading-8 cursor-pointer" href="https://github.com/edekeemmanuel/">
      <span className="relative 2xs:left-12 xs:left-16 sm:left-20 md:left-[90px] myPhone:left-[55%] myPhone:bottom-1 header__svg bg-neutral-50"><svg height="50px" id="Layer_1" enable-background="new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="50px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><g><path  d="M256,32C132.3,32,32,134.8,32,261.7c0,101.5,64.2,187.5,153.2,217.9c11.2,2.1,15.3-5,15.3-11.1   c0-5.5-0.2-19.9-0.3-39.1c-62.3,13.9-75.5-30.8-75.5-30.8c-10.2-26.5-24.9-33.6-24.9-33.6c-20.3-14.3,1.5-14,1.5-14   c22.5,1.6,34.3,23.7,34.3,23.7c20,35.1,52.4,25,65.2,19.1c2-14.8,7.8-25,14.2-30.7c-49.7-5.8-102-25.5-102-113.5   c0-25.1,8.7-45.6,23-61.6c-2.3-5.8-10-29.2,2.2-60.8c0,0,18.8-6.2,61.6,23.5c17.9-5.1,37-7.6,56.1-7.7c19,0.1,38.2,2.6,56.1,7.7   c42.8-29.7,61.5-23.5,61.5-23.5c12.2,31.6,4.5,55,2.2,60.8c14.3,16.1,23,36.6,23,61.6c0,88.2-52.4,107.6-102.3,113.3   c8,7.1,15.2,21.1,15.2,42.5c0,30.7-0.3,55.5-0.3,63c0,6.1,4,13.3,15.4,11C415.9,449.1,480,363.1,480,261.7   C480,134.8,379.7,32,256,32z"/></g></svg> </span>
        <span className="relative myPhone:bottom-[15%] myPhone:left-[55%]  4xs:text-[12px] 4xs:bottom-1 4xs:left-1 3xs:text-[14px] 3xs:left-0 2xs:text-[18px] xs:text-[20px] sm:text-[18px] sm:left-1 md:text-[20px] myPhone:text-[6px]">GitHub</span>
      </a>
    </div>
    <div className="relative 2xs:left-20 xs:left-28 sm:left-32 md:left-[165px] myPhone:left-[61%]">
      <a>
        <img className="4xs:w-[30px] 4xs:h-[30px] myPhone:w-[40px] myPhone:h-[40px] md:w-[70px] md:h-[70px]" src={"./resumes.png"} />
        <span className="relative 4xs:text-[12px] 4xs:bottom-1 4xs:right-9 myPhone:right-0.5 myPhone:text-[6px] 3xs:text-[14px] 2xs:text-[18px] xs:text-[20px] 3xs:right-10 2xs:right-12 xs:right-16 sm:text-[18px] sm:right-20 md:right-[90px] md:text-[20px] ">CV</span>
      </a>
    </div>
    </header>
    )
